...
exports.App = core_1.withStyles(styles_1.AppStyles)((props) => {
    ...
    const [store, dispatch] = React.useReducer(store_1.appReducer, initialState);
    ...
    const isHeadCommit = store.interactionStore.selectedCommitId &&
    ...
    if (props.options.showToolbar) {
        panels.push(React.createElement("div", { key: "0.0", "data-grid": { x: 0, y: 0, w: 12, h: 2 }, className: props.classes.header_bar },
            ...
            React.createElement(exports.PanelContent, null,
                React.createElement(core_1.Button, { size: "small", onClick: () => dispatch({ type: "load", vcStore: persistence.load() }) }, "(Persistence) Load"),
    ...
    return (React.createElement(ReactGridLayout, { rowHeight: (innerHeight - 70) / 20, maxRows: 20, compactType: "vertical", cols: 12, margin: [5, 5], containerPadding: [5, 5], useCSSTransforms: true, draggableCancel: props.classes.panel_content, className: props.classes.layout },
        ...
        React.createElement("div", { key: "0.1", "data-grid": { x: 0, y: 1, w: 3, h: 13 }, className: props.classes.version_control },
            React.createElement(exports.PanelHeading, null,
                ...
                isHeadCommit && (React.createElement("button", { onClick: () => dispatch({ type: "selectCommit", commitId: null }) }, "Switch to HEAD"))),
            React.createElement(exports.PanelContent, null,
                React.createElement(staging_scm_1.SCMPanel, { store: store, isHeadCommit: isHeadCommit, dispatch: dispatch }))),
        React.createElement("div", { key: "0.2", "data-grid": { x: 3, y: 1, w: 6, h: 13 }, className: props.classes.editor },
            React.createElement(exports.PanelHeading, null, !((_b = store.interactionStore.selectedView) === null || _b === void 0 ? void 0 : _b.fullPath)
                ? "Editor"
                : `Editor - ${(_c = store.interactionStore.selectedView) === null || _c === void 0 ? void 0 : _c.fullPath} @ ${(_d = store.interactionStore.selectedView) === null || _d === void 0 ? void 0 : _d.revision} ${((_e = store.interactionStore.selectedView) === null || _e === void 0 ? void 0 : _e.label) || ""}`),
            React.createElement(exports.PanelContent, null,
