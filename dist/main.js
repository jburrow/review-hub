...
react_dom_1.render(React.createElement(app_1.App, { persistence: demo_store_1.demoStore, currentUser: "current-user", options: { loadOnStartup: true, showToolbar: true }, buttons: [
        {
            title: "Download Zip",
